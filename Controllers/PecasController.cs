...
namespace MechSoft.Controllers
{
    public class PecasController : Controller
    {
        ...
        public PecasController(Contexto context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Descricao,Fornecedor,Estoque")] Peca peca)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Descricao,Fornecedor,Estoque")] Peca peca)
        {
            if (id != peca.Id)
            {
                return NotFound();
